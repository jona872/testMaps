...
var map;
var TILE_SIZE = 256;
var argentina = new google.maps.LatLng(41.850033,-87.6500523);
...
function createInfoWindowContent() {
  ...
  var worldCoordinate = projection.fromLatLngToPoint(argentina);
  ...
  return [
    'argentina, IL',
    'LatLng: ' + argentina.lat() + ' , ' + argentina.lng(),
...
function initialize() {
  ...
  coordInfoWindow.setPosition(argentina);
